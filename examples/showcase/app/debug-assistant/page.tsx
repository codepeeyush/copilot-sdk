...
import { ConsoleViewer, type LogEntry } from "./components/ConsoleViewer";
import {
  ScreenshotPreview,
  type Screenshot,
} from "./components/ScreenshotPreview";
import { BugReportForm, type BugReport } from "./components/BugReportForm";
...
function DebugContent() {
  ...
  useTool({
    ...
    needsApproval: true,
    approvalMessage: (params: { title: string }) =>
