...
export function NotebookIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        opacity="0.4"
        d="M22 14V10C22 6.22876 22 4.34315 20.8284 3.17157C19.6569 2 17.7712 2 14 2H12C10.8302 2 9.84189 2 9 2.03496V21.965C9.84189 22 10.8302 22 12 22H14C17.7712 22 19.6569 22 20.8284 20.8284C22 19.6569 22 17.7712 22 14Z"
        fill="currentColor"
      />
      <path
