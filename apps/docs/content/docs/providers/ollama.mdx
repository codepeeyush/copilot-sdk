...
<div className="not-prose mb-8 p-6 rounded-xl border bg-gradient-to-br from-stone-500/5 to-zinc-500/10">
  <div className="flex items-center gap-4">
    <div className="text-5xl">🦙</div>
    <div>
      <h2 className="text-2xl font-bold m-0">Ollama</h2>
      <p className="text-muted-foreground m-0">Run models locally - free & private</p>
    </div>
  </div>
</div>
