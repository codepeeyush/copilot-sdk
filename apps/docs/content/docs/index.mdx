...
<DocsHero
  title="Build AI Copilots for Your App"
  description="Pick any LLM, drop in prebuilt chat UI, and ship AI-powered features in minutes. Full tool execution and agentic loops included."
